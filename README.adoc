...
image:https://maven-badges.herokuapp.com/maven-central/io.github.cuioss.test/cui-test-value-objects/badge.svg[Maven Central,link=https://maven-badges.herokuapp.com/maven-central/io.github.cuioss.test/cui-test-value-objects]
