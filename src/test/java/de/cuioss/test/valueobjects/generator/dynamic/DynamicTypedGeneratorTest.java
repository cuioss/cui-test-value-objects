...
class DynamicTypedGeneratorTest {
    ...
    @Test void shouldHandleInterfaces() {
    ...
    @Test void shouldHandleAbstractClasses() {
    ...
    @Test void shouldHandleDifficultTypes() {
    ...
    @Test void shouldHandleSortedSets() {
