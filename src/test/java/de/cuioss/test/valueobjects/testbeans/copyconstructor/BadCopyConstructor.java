...
@EqualsAndHashCode
@ToString
public class BadCopyConstructor implements Serializable {
    ...
    public static final TestContract<BadCopyConstructor> MOCK_INSTANTIATOR_CONTRACT = new MockTestContract<>(
            new ConstructorBasedInstantiator<>(BadCopyConstructor.class, RUNTIME_PROPERTIES));

    @Getter
    @NonNull
    private final String attribute;

    public BadCopyConstructor(final BadCopyConstructor copyFrom) {
        this(copyFrom.attribute + copyFrom.attribute);
    }
}
