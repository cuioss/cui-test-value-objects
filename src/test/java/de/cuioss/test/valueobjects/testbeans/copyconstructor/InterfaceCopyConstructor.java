...
public class InterfaceCopyConstructor implements Serializable {
    ...
    public static final TestContract<InterfaceCopyConstructor> MOCK_INSTANTIATOR_CONTRACT = new MockTestContract<>(
        new ConstructorBasedInstantiator<>(InterfaceCopyConstructor.class, RUNTIME_PROPERTIES));
