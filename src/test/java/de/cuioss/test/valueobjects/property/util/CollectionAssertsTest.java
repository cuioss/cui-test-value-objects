...
class CollectionAssertsTest {
    ...
    @Test void shouldPassOnBothNullOrEmpty() {
    ...
    @Test @SuppressWarnings("java:S5778") // owolff: new ArrayList<>() is not a problem
    ...
    @Test void shouldPassOnListWithDifferetnOrder() {
        final var list = Generators.asCollectionGenerator(Generators.strings()).list();
    ...
    @Test void shouldFailWithNonEqualContent() {
    ...
    @Test void shouldFailWithNonEqualContentReverse() {
        final List<String> list1 = immutableList("a", "b", "b");
        final List<String> list2 = immutableList("a", "b", "c");
