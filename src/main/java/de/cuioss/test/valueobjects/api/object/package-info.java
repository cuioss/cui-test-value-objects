 ...
 * will implicitly be run by {@link de.cuioss.test.valueobjects.ValueObjectTest}. If you
 * want to
 * skip a certain test you can use
 * {@link de.cuioss.test.valueobjects.api.object.VetoObjectTestContract} to do so:
 * {@code @VetoObjectTestContract(ObjectTestContracts#SERIALIZABLE)}
 * will result in the
 * {@link de.cuioss.test.valueobjects.contract.SerializableContractImpl} not to being run.
