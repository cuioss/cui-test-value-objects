 ...
 * {@link de.cuioss.test.valueobjects.property.PropertyMetadata} objects that represent the
 ...
 * are represented by instances of {@link de.cuioss.test.valueobjects.property.PropertyMetadata}
 * </p>
 * The resolving of {@link de.cuioss.test.valueobjects.property.PropertyMetadata} consists of
 * three steps:
 * <ul>
 ...
 * <li>The annotations {@link de.cuioss.test.valueobjects.api.property.PropertyConfig} and
 * {@link de.cuioss.test.valueobjects.api.property.PropertyBuilderConfig} will be evaluated. The
 * first two steps will be aggregated to a superset of
 * {@link de.cuioss.test.valueobjects.property.PropertyMetadata} to be used for all other
 * tests. The result will be logged at info-level in order to simplify the adjustment.</li>
 * <li>The individual tests, e.g.
 * {@link de.cuioss.test.valueobjects.api.contracts.VerifyBeanProperty} can further tweak the
