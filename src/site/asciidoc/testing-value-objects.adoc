...
See link:managing-metadata.md[Managing Metadata], and link:generator-system.md[Generator System] and link:reflection-system.md[Reflection System]  for details.
...
Compared to the standard testing executed in the context of link:simple-canonical-object-methods.md[Simplified Testing of Canonical Object Methods] these tests do real in-depth inspection, testing many variants iterating through all properties and its permutations. 
...
If you set the property `equalsAndHashCodeBasicOnly` or `serializableBasicOnly` you will get exactly the same behavior as described within link:simple-canonical-object-methods.md[Simplified Testing of Canonical Object Methods].
